...
async def convert_video(video_file, output_directory, total_time, bot, message, chan_msg):
    ...
    with open(progress, 'w') as f:
      pass
    ##  -metadata title='Anime Horizon [Join t.me/AnimeX_Horizon]' -vf drawtext=fontfile=Italic.ttf:fontsize=20:fontcolor=black:x=15:y=15:text='AnimeX_Horizon'
